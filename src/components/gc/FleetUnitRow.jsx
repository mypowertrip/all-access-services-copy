...
export default function FleetUnitRow({ unit }) {
  return (
    <tr className="border-t border-border hover:bg-accent/30 transition-colors">
      ...
      <td className="px-4 py-3 text-xs text-muted-foreground hidden sm:table-cell">{unit.site}</td>
      <td className="px-4 py-3">
      ...
      <td className="px-4 py-3 text-xs text-muted-foreground hidden md:table-cell">{unit.hours}h</td>
      <td className="px-4 py-3 text-xs text-muted-foreground hidden md:table-cell">{unit.nextService}</td>
      <td className="px-4 py-3">
