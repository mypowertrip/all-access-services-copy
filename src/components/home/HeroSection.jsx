  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute top-8 left-6 md:left-16 lg:top-10 z-10 flex items-center gap-2.5 px-3 py-1.5 bg-black/80 border border-orange-500/40 backdrop-blur-sm"
      >
