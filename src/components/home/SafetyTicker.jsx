...
const ITEMS = [
  ...
  "SAFETY ISN'T JUST A BOX WE CHECK — IT'S FUNDAMENTAL TO OUR BUSINESS",
  'FIND OUT WHAT WE DO DIFFERENT — READ OUR SAFETY COMMITMENT',
  'JLG FACTORY AUTHORIZED TECHNICIANS · MOST METICULOUSLY MAINTAINED FLEET',
  'LIVES ARE ON THE LINE WHEN WORKING AT HEIGHTS — WE NEVER FORGET THAT',
];
